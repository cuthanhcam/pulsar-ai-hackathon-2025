...
import { Key, Save, ArrowLeft, Eye, EyeOff, Loader2, Zap, AlertCircle, CheckCircle2 } from 'lucide-react'
  ...
  useEffect(() => {
    const fetchCurrentKey = async () => {
      ...
      try {
        ...
        if (keyResponse.ok && keyData.geminiApiKey) {
          setCurrentApiKey(keyData.geminiApiKey)
  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-5xl">
        ...
        {/* Alerts */}
        {success && (
          <div className="mb-6 p-4 bg-green-500/10 border-2 border-green-500/50 rounded-xl flex items-start gap-3">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Info Box */}
            <div className="bg-zinc-900/50 border-2 border-zinc-800 rounded-2xl p-6">
          ...
          <div className="space-y-6">
            {/* Credits Card */}
            <div className="bg-gradient-to-br from-orange-500/10 to-zinc-900 border-2 border-orange-500/20 rounded-2xl p-6 relative overflow-hidden">
